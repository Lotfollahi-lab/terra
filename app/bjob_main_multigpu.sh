...
# Run main script
python main.py --fname /lustre/scratch126/cellgen/team361/sb75/nichejepa-reproducibility/config/model/human_cohort1_2m_cell_graph.yaml --devices cuda:0 cuda:1
