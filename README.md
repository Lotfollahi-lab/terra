...
## Overview
nichejepa is a machine learning framework designed for gene transformer models, providing robust training and evaluation workflows. This repository includes all necessary scripts and configurations for running comprehensive training sweeps and evaluations.
...
Manages the evaluation process. It evaluates the trained model on the specified tasks.

6. src/nichejepa/utils/emb_utils.py
Provides utility functions for handling and loading embeddings required by the model during  inference.
